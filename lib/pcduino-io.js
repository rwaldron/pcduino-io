...
pcDuino.prototype.i2cConfig = function() {
  throw new Error("i2cConfig not yet implemented");
};

pcDuino.prototype.i2cWrite = function() {
  throw new Error("i2cWrite not yet implemented");
};

pcDuino.prototype.i2cWriteReg = function() {
  throw new Error("i2cWriteReg not yet implemented");
};

pcDuino.prototype.i2cRead = function() {
  throw new Error("i2cRead not yet implemented");
};

pcDuino.prototype.i2cReadOnce = function() {
  throw new Error("i2cReadOnce not yet implemented");
};
